...
export async function POST(request: Request) {
  try { return Response.json(await validateConfiguration(await authenticateStorefront(request), parseValidateConfiguration(await request.json())), { headers: storefrontCors }); }
