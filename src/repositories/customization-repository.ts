...
export async function createCustomizationInstance(args: { shopId: string; customerId: string | null; input: CreateCustomizationInput; templateId: string; templateCode: string; templateVersion: number; schemaVersion: number; summary: string }) {
