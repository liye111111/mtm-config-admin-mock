...
type PurchaseMode = "ready_to_wear" | "custom";
...
template_version
status
selected_pieces_json
piece_configurations_json
...
- 主题所需的 `templateId`、`version`、`steps`、`pieces` 和尺寸字段在迁移期保持可读；
